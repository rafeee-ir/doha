                                ...
                                <div class="row my-5">
                                    <div class="col-md-3">
                                        <div class="d-grid gap-2">
                                            <button class="btn btn-secondary" type="button">دانلود کاتالوگ بزودی</button>
                                        </div>
                                    </div>
                                </div>

                                    <p class="pt-3" style="font-size: 1.1rem">
                                        دفتر ترویج تجارت با همکاری شرکت هفت اقلیم با کسب مجوز برگزاری پاویون جمهوری اسلامی ایران در اکسپو 2023 قطر، بصورت رسمی عهده دار این مسئولیت از سوی سازمان توسعه تجارت ایران گردیدند. مجوز برگزاری نمایشگاه طبق سند شماره 1402/320/2189 که در تاریخ 1402/04/31 صادر شده است.
                                    </p>
                                    <p class="pt-3" style="font-size: 1.1rem">
